...
export default function Hero() {
    return (
      <section className="relative h-screen bg-cover bg-center" style={{ backgroundImage: "url('/istockphoto.jpg')" }}>
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center h-full px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white">
            Welcome to <span className="text-blue-500">Online-Solution Shop</span>
          </h1>
