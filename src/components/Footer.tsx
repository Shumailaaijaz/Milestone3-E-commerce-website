          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-400">
                Your Online-solution shop for the best products. Dedicated to providing you with quality and service.
              </p>
              <p className="mt-4 text-gray-400">© 2025 Your Company. All rights reserved.</p>
            </div>
